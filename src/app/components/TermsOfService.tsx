...
export function TermsOfService() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-gray-600 leading-relaxed text-sm mt-3">You agree to:</p>
    ...
    {
      title: "5. User Roles and Access Levels",
      content: (
        <>
          <p className="text-gray-600 leading-relaxed text-sm">
    ...
    {
      title: "8. Facility and Amenity Bookings",
      content: (
        <>
          <p className="text-gray-600 leading-relaxed text-sm">
    ...
    {
      title: "11. Complaint and Helpdesk",
      content: (
        <>
          <p className="text-gray-600 leading-relaxed text-sm">
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-[#2B2D42] text-white pt-28 pb-16 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(250,204,21,0.08),transparent_60%)]" />
