        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed text-sm mb-2">
                When you access our Services through a mobile device or computer:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-600 text-sm mb-5">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">3. How We Collect Information</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">4. How We Use Your Information</h2>
              <p className="text-gray-600 leading-relaxed text-sm mb-3">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">5. Data Sharing and Disclosure</h2>
              <p className="text-gray-600 leading-relaxed text-sm mb-3">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">6. Data Security</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">7. Data Retention</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">8. Your Rights and Choices</h2>
              <p className="text-gray-600 leading-relaxed text-sm mb-3">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">9. Cookies and Tracking Technologies</h2>
              <p className="text-gray-600 leading-relaxed text-sm mb-3">
                Our website and application may use cookies and similar tracking technologies to enhance your experience. The types of cookies we use include:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-gray-600 text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">10. Children's Privacy</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">11. Third-Party Links and Services</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">12. International Data Transfers</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">13. Data Breach Notification</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">14. Legal Basis for Processing</h2>
              <p className="text-gray-600 leading-relaxed text-sm mb-3">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">15. Automated Decision-Making</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">16. Changes to This Privacy Policy</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">17. Grievance Officer</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#2B2D42] mb-3">18. Contact Us</h2>
              <p className="text-gray-600 leading-relaxed text-sm">
